// Package rlpstruct 实现RLP编码/解码的struct处理。
//
// 特别地，这个包处理所有关于字段过滤，结构标签和空值确定的规则。
package rlpstruct
...
type Type struct {
	Name      string
	Kind      reflect.Kind
	IsEncoder bool  // type 是否实现 rlp.Encoder
	IsDecoder bool  // type 是否实现 rlp.Decoder
	Elem      *Type // Ptr, Slice, Array的Kind值非nil
}
